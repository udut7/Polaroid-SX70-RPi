...
text2 = font2.render('by Poltak Marudut', True, (255, 165, 0))
...
try:
 while True:
  ...
  while exposure < 3:
   ...
   exp_name = 'exposure_' + exposure + '.jpg'  
   camera.capture(de_path + ext_name)
  ...
  imege5 = Image.blend(image3, image4, alpha=0.1)
  ...
  consumer_key = 'Nca0aTbcn2sAgd41YoSCl8HQ8'  
  consumer_secret = 'QXe49OWw9Tu95tt3TO5vB85vuOQnLujL9uOsDP9XbEAimTNA2d'  
  access_token = '1103195281498099713-8pXCjS6TdqsVZONJpy0cTxwZUfa3Gx'  
  access_token_secret = 'vTnpSMdXagNe6Y4yhQt0JS73IJc4AKIaycLg6yV3IbfvR'  
